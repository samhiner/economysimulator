...
if ($playerCount != 1) {
	header("location: http://dsasadsdalocalhost/economysimulator/acct/home"); //ISSUE depending on path of file (if index doesnt do full path and justy is straight on domain) using verify the redirect is different (whether contains ../)
}
